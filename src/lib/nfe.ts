...
export function parseOrcamentoTexto(texto: string): NfeItem[] {
  ...
  // normaliza e pré-processa: emenda linha de item quebrada com a linha
  // seguinte quando ela contém só números (totais que caíram de linha)
  ...
  for (const line of linhas) {
    ...
    // só o valor unitário no fim (total caiu da linha): total = qtd × unitário
    ...
    // plano B: codigo + descricao + dois números no fim
